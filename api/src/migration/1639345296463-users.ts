...
export class users1639345296463 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "UX_normalized_email" ON "users" ("normalizedEmail") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "UX_normalized_username" ON "users" ("normalizedUsername") `);
